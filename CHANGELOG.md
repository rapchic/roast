...
- Remove `docs/` — reabsorb into README (user/CLI/troubleshooting) and CONTRIBUTING (releasing + CodeRabbit)
- Skill playbooks stay under `skills/roast/references/`
- SEO: richer `package.json` description/keywords; GitHub About + topics

## [0.1.3] - 2026-08-06

### Added

- `/roast-learn` modes: **once** (default), **continuous**, optional **transcripts** (Cursor agent chats)
- Continuous: `/roast` folds new evidenced antipatterns into `roast-patterns.mdc`
