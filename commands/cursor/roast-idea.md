---
description: "/roast-idea — command (critique plan). Loads roast-full skill; no code until agreed"
---
...
If missing: run **`/roast-install`**, or `npx @rapchic/roast@latest install` then restart Cursor — do not proceed with a vague review.
